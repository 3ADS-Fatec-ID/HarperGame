...
public class MainCharacter {
	...
	public MainCharacter() {
		...
		normalRunAnim.addFrame(Resource.getResouceImage("data/nave.png"));
		normalRunAnim.addFrame(Resource.getResouceImage("data/nave.png"));
		...
		deathAnimation.addFrame(Resource.getResouceImage("data/explosao_frame1.png"));
		deathAnimation.addFrame(Resource.getResouceImage("data/explosao_frame2.png"));
		deathAnimation.addFrame(Resource.getResouceImage("data/explosao_frame3.png"));
	...
	public void draw(Graphics g) {
		...
		case DOWN_RUN:
			...
			break;
		case DEATH:
			g.drawImage(deathAnimation.getFrame(), (int) posX, (int) posY, null);
			break;
		}
...
//		g.drawRect(bound.x, bound.y, bound.width, bound.height);
	...
	public void update() {
		...
		deathAnimation.updateFrame();
		/*
		 * if(posY >= LAND_POSY) { posY = LAND_POSY; if(state != DOWN_RUN) { state =
		 * NORMAL_RUN; } } else {
		 * 
		 * }
		 */
	...
	public void flyUp(boolean isPressed) {
		if (isPressed == true) {
			speedY = -2f;
		} else {
			speedY = 0;
	...
	public void flyDown(boolean isPressed) {
		if (isPressed == true) {
			speedY = 2f;
		} else {
			speedY = 0;
	...
	public void shoot() {
		Bullet b = new Bullet(55, (int) posY + 10);
		bullets.add(b);
	}
